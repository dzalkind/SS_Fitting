function [AsNum,AsDen]=ident_retardation_FDna(W,Ajw,order,MethOpt,PlotOpt)
...
%
% Use: [AsNum,AsDen]=ident_retardation_FD(W,Ajw,order,MethOpt,PlotOpt)
%
% Output:
% AsNum,AsDen - the indetified transfer function numenrator and denominator 
%
% Inputs:
